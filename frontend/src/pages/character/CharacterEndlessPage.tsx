...
function CharacterEndlessPage() {
  ...
  return (
    <TooltipProvider delayDuration={200}>
      <div className="flex min-h-svh w-full flex-col flex-wrap items-center justify-center px-6">
        ...
        <div className="mt-6 flex w-full max-w-6xl flex-col gap-8 rounded-xl border border-border bg-card p-8 text-card-foreground shadow-md">
          ...
          <section className="flex flex-col items-center gap-4">
            {foundAnime ? (
              ...
              <>
                <h1 className="font-bold text-2xl text-primary">{t('character.endlessGuessTitle')}</h1>
