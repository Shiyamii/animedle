...
export function useCharacterEndlessPageViewModel() {
  ...
  const [rulesConfig, setRulesConfig] = useState<Pick<CharacterDailyHintConfigDTO, 'hintTiers' | 'imageBlur'> | null>(
    null,
  );
  ...
  }, [animeStore.clearCharacterEndlessGuessList, animeStore.loadAnimeList, animeStore.setCharacterEndlessTarget]);
